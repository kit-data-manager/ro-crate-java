 ...
 * a zip archive.
 */
public class ZipStreamWriter implements GenericWriterStrategy<OutputStream> {

    private static final Logger logger = LoggerFactory.getLogger(ZipStreamWriter.class);
